...
- Name: Tests\SmokeTests\ConvCard Smoke.spec.js >> ConvCard Smoke Test
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e48]:
        - generic [ref=e52]:
          ...
          - generic [ref=e57]: 04/13/2026 07:39:56
        - generic [ref=e60]:
          - generic [ref=e61]:
            - generic:
              - generic [ref=e62]:
...
```ts
  ...
  5  | 
  6  | test('ConvCard Smoke Test', async ({ page }, testInfo) => {
  ...
  24 | 	await captureStepScreenshot( {page, testInfo, stepName: 'validateHomePage'} );
  25 | 
